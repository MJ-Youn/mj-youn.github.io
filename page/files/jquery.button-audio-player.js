/*! For license information please see jquery.button-audio-player.js.LICENSE.txt */ ! function (e) {
	var t = {};
	...
	! function (t, n) {
		...
		var E = function (e) {
			...
			for (t in n = se.support = {}, o = se.isXML = function (e) {
					...
					return a != d && 9 === a.nodeType && a.documentElement ? (h = (d = a).documentElement, g = !o(d), w != d && (i = d.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", oe, !1) : i.attachEvent && i.attachEvent("onunload", oe)), n.scope = ce((function (e) {
						...
						return r || (1 & (r = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === r ? e == d || e.ownerDocument == w && x(w, e) ? -1 : t == d || t.ownerDocument == w && x(w, t) ? 1 : c ? M(c, e) - M(c, t) : 0 : 4 & r ? -1 : 1)
					} : function (e, t) {
						if (e === t) return f = !0, 0;
						var n, r = 0,
							i = e.parentNode,
				...
				return r && !r[b] && (r = Ce(r)), i && !i[b] && (i = Ce(i, o)), le((function (o, a, s, u) {
					...
					if (o) {
						if (i || e) {
							...
							for (c = m.length; c--;)(f = m[c]) && (l = i ? M(o, f) : p[c]) > -1 && (o[l] = !(a[l] = f))
						}
						...
						var n = t.length > 0,
							...
							o = function (o, a, s, u, c) {
								...
								if (m += y, n && y !== m) {
									...
									O.apply(u, b), c && !o && b.length > 0 && m + t.length > 1 && se.uniqueSort(u)
								}
								return c && (T = S, l = w), x
							};
						return n ? le(o) : o
		...
		C.fn.extend({
			...
			C.fn[e] = function (n, r) {
				...
				return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = C.filter(r, i)), this.length > 1 && (M[e] || C.uniqueSort(i), H.test(e) && i.reverse()), this.pushStack(i)
			}
		}));
		var R = /[^\x20\t\r\n\f]+/g;
				...
				var t = [
					...
					i = {
						...
						then: function (e, r, i) {
							...
							return C.Deferred((function (n) {
								t[0][3].add(a(0, n, m(i) ? i : $, n.notifyWith)), t[1][3].add(a(0, n, m(e) ? e : $)), t[2][3].add(a(0, n, m(r) ? r : I))
							})).promise()
						},
						promise: function (e) {
			...
			add: function (e, t, n, r, i) {
				...
				if (Q(e))
					for (n.handler && (n = (o = n).handler, i = o.selector), i && C.find.matchesSelector(oe, i), n.guid || (n.guid = C.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (t) {
						...
						}), l = (t = (t || "").match(R) || [""]).length; l--;) d = g = (s = Ee.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = C.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = C.event.special[d] || {}, c = C.extend({
						type: d,
						origType: g,
						data: r,
						handler: n,
		...
		function Ie(e, t, n, r) {
			...
			if (p && (o = (i = Te(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
				for (s = (a = C.map(xe(i, "script"), Me)).length; f < p; f++) l = i, f !== d && (l = C.clone(l, !0, !0), s && C.merge(a, xe(l, "script"))), n.call(e[f], l, f);
				if (s)
					for (c = a[a.length - 1].ownerDocument, C.map(a, Pe), f = 0; f < s; f++) l = a[f], me.test(l.type || "") && !J.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
		...
		C.extend({
			...
			clone: function (e, t, n) {
				...
				if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
					for (a = xe(s), r = 0, i = (o = xe(e)).length; r < i; r++) $e(o[r], a[r]);
				if (t)
					if (n)
						for (o = o || xe(e), a = a || xe(s), r = 0, i = o.length; r < i; r++) Re(o[r], a[r]);
					else Re(e, s);
		...
		function Ve(e, t, n) {
			...
			return (n = n || Be(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ae(e) || (a = C.style(e, t)), !v.pixelBoxStyles() && We.test(a) && ze.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
		}
		...
		C.extend({
			...
			css: function (e, t, n, r) {
				var i, o, a, s = G(t);
				return Ke.test(t) || (t = Ye(s)), (a = C.cssHooks[t] || C.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ve(e, t, r)), "normal" === i && t in et && (i = et[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
			}
		...
		function dt(e, t, n) {
			...
			return C.map(c, pt, l), m(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), C.fx.timer(C.extend(u, {
				elem: e,
				anim: l,
				queue: l.opts.queue
			})), l
		...
		C.extend(C.event, {
			trigger: function (e, t, r, i) {
				...
				if (a = p = s = r = r || x, 3 !== r.nodeType && 8 !== r.nodeType && !Tt.test(g + C.event.triggered) && (g.indexOf(".") > -1 && (v = g.split("."), g = v.shift(), v.sort()), l = g.indexOf(":") < 0 && "on" + g, (e = e[C.expando] ? e : new C.Event(g, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = v.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : C.makeArray(t, [e]), f = C.event.special[g] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, t))) {
					...
					for (o = 0;
						(a = h[o++]) && !e.isPropagationStopped();) p = a, e.type = o > 1 ? u : f.bindType || g, (c = (J.get(a, "events") || Object.create(null))[e.type] && J.get(a, "handle")) && c.apply(a, t), (c = l && a[l]) && c.apply && Q(a) && (e.result = c.apply(a, t), !1 === e.result && e.preventDefault());
					return e.type = g, i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !Q(r) || l && m(r[g]) && !y(r) && ((s = r[l]) && (r[l] = null), C.event.triggered = g, e.isPropagationStopped() && p.addEventListener(g, Ct), r[g](), e.isPropagationStopped() && p.removeEventListener(g, Ct), C.event.triggered = void 0, s && (r[l] = s)), e.result
				}
			},
		...
		Wt.href = St.href, C.extend({
			...
			ajax: function (e, t) {
				...
				if (v.promise(S), d.url = ((e || d.url || St.href) + "").replace(Rt, St.protocol + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(R) || [""], null == d.crossDomain) {
					u = x.createElement("a");
					try {
				...
				if (d.data && d.processData && "string" != typeof d.data && (d.data = C.param(d.data, d.traditional)), _t($t, d, t, S), l) return S;
				for (f in (c = C.event && d.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Pt.test(d.type), i = d.url.replace(Ot, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(qt, "+")) : (p = d.url.slice(i.length), d.data && (d.processData || "string" == typeof d.data) && (i += (kt.test(i) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (i = i.replace(Ht, "$1"), p = (kt.test(i) ? "&" : "?") + "_=" + Et.guid++ + p), d.url = i + p), d.ifModified && (C.lastModified[i] && S.setRequestHeader("If-Modified-Since", C.lastModified[i]), C.etag[i] && S.setRequestHeader("If-None-Match", C.etag[i])), (d.data && d.hasContent && !1 !== d.contentType || t.contentType) && S.setRequestHeader("Content-Type", d.contentType), S.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : d.accepts["*"]), d.headers) S.setRequestHeader(f, d.headers[f]);
				if (d.beforeSend && (!1 === d.beforeSend.call(h, S, d) || l)) return S.abort();
				if (T = "abort", m.add(d.complete), S.done(d.success), S.fail(d.error), r = _t(It, d, t, S)) {
				...
				function E(e, t, a, u) {
					var f, p, x, b, w, T = t;
					l || (l = !0, s && n.clearTimeout(s), r = void 0, o = u || "", S.readyState = e > 0 ? 4 : 0, f = e >= 200 && e < 300 || 304 === e, a && (b = function (e, t, n) {
					...
					}(d, S, a)), !f && C.inArray("script", d.dataTypes) > -1 && (d.converters["text script"] = function () {}), b = function (e, t, n, r) {
						var i, o, a, s, u, l = {},
							c = e.dataTypes.slice();
						if (c[1])
					...
					}(d, b, S, f), f ? (d.ifModified && ((w = S.getResponseHeader("Last-Modified")) && (C.lastModified[i] = w), (w = S.getResponseHeader("etag")) && (C.etag[i] = w)), 204 === e || "HEAD" === d.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = b.state, p = b.data, f = !(x = b.error))) : (x = T, !e && T || (T = "error", e < 0 && (e = 0))), S.status = e, S.statusText = (t || T) + "", f ? v.resolveWith(h, [p, T, S]) : v.rejectWith(h, [S, T, x]), S.statusCode(y), y = void 0, c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [S, d, f ? p : x]), m.fireWith(h, [S, T]), c && (g.trigger("ajaxComplete", [S, d]), --C.active || C.event.trigger("ajaxStop")))
				}
				return S
			},
		...
		C.ajaxSetup({
			...
			if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Qt, "$1" + i) : !1 !== e.jsonp && (e.url += (kt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
				return a || C.error(i + " was not called"), a[0]
			}, e.dataTypes[0] = "json", o = n[i], n[i] = function () {
				a = arguments
			}, r.always((function () {
				void 0 === o ? C(n).removeProp(i) : n[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, Gt.push(i)), a && m(o) && o(a[0]), a = o = void 0
			})), "script"
		})), v.createHTMLDocument = ((Xt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Xt.childNodes.length), C.parseHTML = function (e, t, n) {
	...
	function r(e) {
		this.btnOnSVG = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" class="bi bi-volume-up-fill"><path d="M11.536 14.01A8.473 8.473 0 0 0 14.026 8a8.473 8.473 0 0 0-2.49-6.01l-.708.707A7.476 7.476 0 0 1 13.025 8c0 2.071-.84 3.946-2.197 5.303l.708.707z"></path><path d="M10.121 12.596A6.48 6.48 0 0 0 12.025 8a6.48 6.48 0 0 0-1.904-4.596l-.707.707A5.483 5.483 0 0 1 11.025 8a5.483 5.483 0 0 1-1.61 3.89l.706.706z"></path><path d="M8.707 11.182A4.486 4.486 0 0 0 10.025 8a4.486 4.486 0 0 0-1.318-3.182L8 5.525A3.489 3.489 0 0 1 9.025 8 3.49 3.49 0 0 1 8 10.475l.707.707zM6.717 3.55A.5.5 0 0 1 7 4v8a.5.5 0 0 1-.812.39L3.825 10.5H1.5A.5.5 0 0 1 1 10V6a.5.5 0 0 1 .5-.5h2.325l2.363-1.89a.5.5 0 0 1 .529-.06z"></path></svg>',  this.btnOffSVG = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" class="bi bi-volume-mute-fill"><path d="M6.717 3.55A.5.5 0 0 1 7 4v8a.5.5 0 0 1-.812.39L3.825 10.5H1.5A.5.5 0 0 1 1 10V6a.5.5 0 0 1 .5-.5h2.325l2.363-1.89a.5.5 0 0 1 .529-.06zm7.137 2.096a.5.5 0 0 1 0 .708L12.207 8l1.647 1.646a.5.5 0 0 1-.708.708L11.5 8.707l-1.646 1.647a.5.5 0 0 1-.708-.708L10.793 8 9.146 6.354a.5.5 0 1 1 .708-.708L11.5 7.293l1.646-1.647a.5.5 0 0 1 .708 0z"></path></svg>', this.audio = e || !1
	}
	n.r(t), r.prototype = {
		init: function (e) {
					...
					click: function (e) {
						...
						var a = t.audio.paused ? i : o,
							s = $("<div/>", {
								class: "bap-icon",
								html: function () {
									t.audio.paused ? ($(this).html(n), t.audio.play()) : ($(this).html(r), t.audio.pause())
								}
							});
		...
		render: function (e) {
			var t = this,
				n = $("<button/>", {
					type: "button",
					html: function () {
						$("<div/>").addClass("bap-bars").html((function () {
							for (var e = 1; e <= 5; e++) {
								var t = $("<span/>").addClass("bap-bar").attr("data-bap-bar", e);
								$(this).append(t)
							}
						})).appendTo(this)
					},
					click: function (e) {
						e.preventDefault(), t.audio.paused ? ($(this).removeClass("bap-deactive").addClass("bap-active"), t.audio.play()) : ($(this).removeClass("bap-active").addClass("bap-deactive"), t.audio.pause())
					}
	...
	var u = function (e) {
		...
		return void 0 === n.length && (n = $(this.option.el)), n.each((function () {
			(this.$elem = $(this), this.audio = !1, t.option.src && (this.audio = new Audio(t.option.src), this.audio.loop = t.option.loop), "bar-animation" === t.option.type) ? new a(this.audio).init(this.$elem): new i(this.audio).init(this.$elem);
			
			if(t.option.autoplay){
				this.audio.autoplay=true;
				try{
					$('#music-play .bap-btn').click();	
				}catch(e){}
				
			}
			console.log(this.audio);
			this.audio.addEventListener("timeupdate", (function () {
				Object(s.isNumeric)(t.option.loopStart) && Object(s.isNumeric)(t.option.loopEnd) && t.option.loopEnd < this.currentTime && (this.currentTime = t.option.loopStart)
			}), !1)
		}))
	};
